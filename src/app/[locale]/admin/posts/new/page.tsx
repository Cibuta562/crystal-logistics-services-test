...
export default function NewPostPage() {
    ...
    const [sections, setSections] = useState<SectionType[]>([emptySection()]);
    ...
    async function onPublish() {
        try {
            ...
            const created = await saveDraft(buildPayload());
            await publishDraft(created.id);
    ...
    return (
        <>
            <div className="mx-auto max-w-6xl space-y-6 p-6">
                <h1 className="text-2xl font-semibold">Post nou</h1>
              ...
              publicare.
                ...
                <div className="flex items-center gap-3">
                    <ImageUploader
                        pathPrefix={`posts/${slug || "draft"}/cover`}
